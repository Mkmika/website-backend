<div class="sticky top-0 flex justify-between items-center px-6 gap-[100px] py-2 sm:flex sm:justify-between sm:items-center sm:px-[150px] sm:py-4 z-10 bg-white  sm:shadow">
    <div class="">
    <img
