                        ...
                        <div class="card-body">
                            <div>
                                <div class="d-xl-flex">
                                    <div class="mb-3 mb-md-0">
                                        <!-- Img -->
                                        <img src="./Job Single _ Geeks - Bootstrap 5 Template_files/job-list-logo-1.svg" alt="Geeks UI - Bootstrap 5 Template" class="icon-shape border rounded-circle">
                                    </div>
                                    <!-- text -->
                            ...
                            <div>
                                <div class="d-xl-flex">
                                    <div class="mb-3 mb-md-0">
                                        ...
                                        <img src="./Job Single _ Geeks - Bootstrap 5 Template_files/job-list-logo-2.svg" alt="Geeks Bootstrap 5 Template" class="icon-shape border rounded-circle">
                                    </div>
                                    <!-- text -->
                                    <div class="ms-xl-3 w-100 mt-3 mt-xl-1">
                            ...
                            <div>
                                <div class="d-xl-flex">
                                    <div class="mb-3 mb-md-0">
                                        ...
                                        <img src="./Job Single _ Geeks - Bootstrap 5 Template_files/job-list-logo-3.svg" alt="Geeks Bootstrap 5 Template" class="icon-shape border rounded-circle">
                                    </div>
                                    <!-- text -->
                                    <div class="ms-xl-3 w-100 mt-3 mt-xl-1">
                                        <div class="d-flex justify-content-between mb-4">
                            ...
                            <div>
                                <div class="d-xl-flex">
                                    <div class="mb-3 mb-md-0">
                                        ...
                                        <img src="./Job Single _ Geeks - Bootstrap 5 Template_files/job-list-logo-4.svg" alt="Geeks Bootstrap 5 Template" class="icon-shape border rounded-circle">
                                    </div>
                                    <!-- text -->
                                    <div class="ms-xl-3 w-100 mt-3 mt-xl-1">
                                        <div class="d-flex justify-content-between mb-4">
